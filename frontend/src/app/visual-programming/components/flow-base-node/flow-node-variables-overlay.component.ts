...
export class FlowNodeVariablesOverlayComponent {
    ...
    public get showInputsOverlay(): boolean {
        return this.showVariables && !!this.baseNode && this.inputKeys.length > 0;
    }

    public get showOutputOverlay(): boolean {
        return this.showVariables && !!this.baseNode && !!this.baseNode.output_variable_path;
    }

    private isBaseNode(node: NodeModel | null | undefined): node is BaseNodeModel & NodeModel {
