...
export class RealtimeClient extends RealtimeEventHandler {
     ...
     */
    constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug, connectionKey, token } = {}) {
        super();
    ...
    _addAPIEventHandlers() {
        ...
        const callTool = async (tool) => {
            try {
                ...
                console.log('tool form backend', tool);
        ...
        this.realtime.on('server.response.function_call_arguments.done', handlerWithDispatch);
