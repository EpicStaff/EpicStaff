...
export class IndexCellRendererComponent implements ICellRendererAngularComp, OnDestroy {
    ...
    private tempVisibleTimeout: ReturnType<typeof setTimeout> | null = null;
