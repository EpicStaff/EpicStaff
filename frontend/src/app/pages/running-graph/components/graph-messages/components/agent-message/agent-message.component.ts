...
export class AgentMessageComponent implements OnInit {
    ...
    public getThought(): string {
        ...
        return (this.message.message_data as AgentMessageData).thought;
    }
    ...
    public getTool(): string {
        ...
        return (this.message.message_data as AgentMessageData).tool;
    }
    ...
    public getToolInput(): string {
        ...
        return (this.message.message_data as AgentMessageData).tool_input;
    }
    ...
    public getParsedJson(type: 'tool' | 'result'): unknown {
        if (type === 'tool') {
