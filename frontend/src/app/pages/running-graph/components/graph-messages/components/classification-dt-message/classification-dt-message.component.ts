            ...
            <div class="dt-flow-container prompt-container">
                ...
                >
                    ...
                    <div class="header-text">
                        ...
                        <span class="badge prompt-badge">{{ getPromptData()?.prompt_id }}</span>
                    </div>
                </div>
                ...
                >
                    <div class="dt-content">
                        ...
                        <div class="detail-row">
                            ...
                            <code class="detail-value code">{{ getPromptData()?.result_variable }}</code>
                        </div>
        ...
        @if (isManipulation()) {
            <div class="dt-flow-container manipulation-container">
                ...
                >
                    ...
                    <div class="header-text">
                        <h3>Manipulation</h3>
                        <span class="badge manipulation-badge">{{ getManipulationData()?.group_name }}</span>
                    </div>
                </div>
...
export class ClassificationDtMessageComponent {
    ...
    isConditionGroup(): boolean {
        return this.message.message_data?.message_type === MessageType.CONDITION_GROUP;
    }

    isClassificationPrompt(): boolean {
        return this.message.message_data?.message_type === MessageType.CLASSIFICATION_PROMPT;
    }

    isManipulation(): boolean {
        return this.message.message_data?.message_type === MessageType.CONDITION_GROUP_MANIPULATION;
    }
