"""Unit tests for tables.services.rbac.delete_collector.build_affected_resources.
...
from tables.services.rbac.delete_collector import ModelCount, build_affected_resources
