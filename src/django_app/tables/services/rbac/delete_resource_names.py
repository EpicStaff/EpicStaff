...
RESOURCE_NAMES: dict[str, str] = {
    # user cascade
    "tables.OrganizationUser": "memberships",
    "tables.ApiKey": "api_keys",
    "tables.PasswordResetToken": "password_reset_tokens",
...
KNOWN_EXCLUDED_LABELS: frozenset[str] = frozenset({
    "tables.StartNode", "tables.EndNode", "tables.CrewNode", "tables.PythonNode",
    "tables.KnowledgeNode", "tables.FileExtractorNode", "tables.AudioTranscriptionNode",
    "tables.SubGraphNode", "tables.DecisionTableNode", "tables.WebhookTriggerNode",
    "tables.TelegramTriggerNode", "tables.ScheduleTriggerNode",
    "tables.ClassificationDecisionTableNode", "tables.TaskNode", "tables.AgentNode",
    "tables.Edge", "tables.ConditionalEdge", "tables.GraphOrganization",
    "tables.GraphOrganizationUser", "tables.GraphNote", "tables.GraphVersion",
    "tables.GraphStorageFile", "tables.AgentNodeTask", "tables.ConditionGroup",
    "tables.Condition", "tables.ClassificationDecisionTablePrompt",
    "tables.ClassificationConditionGroup", "tables.TelegramTriggerNodeField",
    "tables.PythonCodeToolConfig", "tables.PythonCodeResult",
    ...
    "tables.CrewSessionMessage", "tables.GraphSessionMessage",
    "tables.SessionStorageFile", "tables.SessionWarningMessage",
    "tables.SessionTrigger", "tables.SessionPrincipal",
    "tables.AgentSessionMessage", "tables.TaskSessionMessage",
    ...
    "tables.BaseRagType",
    "tables.NaiveRag", "tables.NaiveRagDocumentConfig", "tables.NaiveRagChunk",
    "tables.NaiveRagEmbedding", "tables.NaiveRagPreviewChunk",
    "tables.GraphRag", "tables.GraphRagDocument",
    # RAG search-config sub-detail scoped to an Agent (1:1), implied by
    # "agents":
    "tables.NaiveRagSearchConfig", "tables.GraphRagBasicSearchConfig",
    "tables.GraphRagLocalSearchConfig", "tables.GraphRagGlobalSearchConfig",
    ...
    # "agents"/"tasks"/"tools":
    "tables.AgentMcpTools", "tables.AgentPythonCodeTools",
    "tables.AgentPythonCodeToolConfigs", "tables.AgentNaiveRag",
    "tables.AgentGraphRag", "tables.TaskMcpTools", "tables.TaskPythonCodeTools",
    "tables.TaskPythonCodeToolConfigs",
    # Webhook sub-detail, implied by "webhook_triggers":
    "tables.WebhookTriggerAuth", "tables.NgrokWebhookConfig",
    ...
    "tables.RealtimeAgent", "tables.RealtimeAgentDefinition",
    # Surface sub-detail, implied by "surfaces":
    "agents.AgentDefaultSurface",
    "agents.SurfacePythonTool", "agents.SurfaceMcpTool",
    "agents.SurfaceStorageItem", "agents.SurfaceKnowledge",
    "agents.SurfaceNaiveSearchConfig", "agents.SurfaceGraphBasicSearchConfig",
    ...
    # implied by "flow":
    "agents.InlineSurface", "agents.InlineSurfacePythonTool",
    "agents.InlineSurfaceMcpTool", "agents.InlineSurfaceStorageItem",
    "agents.InlineSurfaceKnowledge", "agents.InlineSurfaceNaiveSearchConfig",
    ...
    "agents.AgentInlineSurface", "agents.AgentInlineSurfacePythonTool",
    "agents.AgentInlineSurfaceMcpTool", "agents.AgentInlineSurfaceStorageItem",
...
def resource_name(label: str) -> str | None:
    ...
    if label in KNOWN_EXCLUDED_LABELS:
        return None
    logger.warning(
        "delete report: unmapped model label {label} -- add it to resource_names.py",
        label=label,
    )
    return None
