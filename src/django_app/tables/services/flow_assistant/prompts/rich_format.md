...
With options:
  {"ef_tables": [{"columns": [{"key": "name", "title": "Name"}, {"key": "type", "title": "Type"}], "rows": [{"name": "customer_intake", "type": "task_node"}], "isEditable": false, "isSortable": true}]}
...
### Combined example
{
  ...
  "ef_tables": [{
    "rows": [
      {"id": 1, "type": "task_node", "name": "customer_intake"},
      {"id": 2, "type": "agent_node", "name": "summarize"},
