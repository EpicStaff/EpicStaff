...
class AudioTranscriptionNodeStrategy(EntityImportExportStrategy):
    ...
    def get_instance(self, entity_id: int) -> AudioTranscriptionNode | None:
    ...
    def extract_dependencies_from_instance(self, instance: AudioTranscriptionNode) -> dict:
        return {EntityType.GRAPH: [instance.graph_id]}

    def export_entity(self, instance: AudioTranscriptionNode) -> dict:
        return self.serializer_class(instance).data

    def create_entity(self, data: dict, id_mapper: IDMapper, **kwargs) -> AudioTranscriptionNode:
