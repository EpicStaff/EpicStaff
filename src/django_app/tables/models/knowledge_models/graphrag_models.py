...
class GraphRagGlobalSearchConfig(models.Model):
    ...
    map_prompt = models.TextField(null=True, blank=True, default=None)
    reduce_prompt = models.TextField(null=True, blank=True, default=None)
    knowledge_prompt = models.TextField(null=True, blank=True, default=None)
...
class GraphRagDriftSearchConfig(models.Model):
    ...
    reduce_prompt = models.TextField(null=True, blank=True, default=None)
    data_max_tokens = models.IntegerField(default=12000)
    reduce_max_tokens = models.IntegerField(null=True, blank=True, default=None)
