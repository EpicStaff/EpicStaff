...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='webhooktriggerauth',
            constraint=models.CheckConstraint(condition=models.Q(models.Q(('is_soft_deleted', False), ('soft_deleted_at__isnull', True)), models.Q(('is_soft_deleted', True), ('soft_deleted_at__isnull', False)), _connector='OR'), name='tables_webhooktriggerauth_soft_delete_consistency'),
        ),
        migrations.AddConstraint(
            model_name='webhooktriggernode',
