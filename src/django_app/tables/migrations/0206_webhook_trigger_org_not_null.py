...
class Migration(migrations.Migration):
    """Enforce NOT NULL on WebhookTrigger.org_id after the backfill.
    ...
    dependencies = [
        ("tables", "0205_backfill_webhook_trigger_org"),
    ]

    operations = [
        migrations.RunSQL(
            sql="ALTER TABLE tables_webhooktrigger ALTER COLUMN org_id SET NOT NULL;",
            reverse_sql="ALTER TABLE tables_webhooktrigger ALTER COLUMN org_id DROP NOT NULL;",
        ),
    ]
