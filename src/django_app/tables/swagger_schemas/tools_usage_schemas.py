...
_USAGE_REQUEST = inline_serializer(
    ...
    fields={
        "ids": drf_serializers.ListField(child=drf_serializers.IntegerField(), required=False),
    },
)
...
PYTHON_CODE_TOOL_USAGE_DETAIL_GET = _usage_detail_get_schema(model_name="PythonCodeTool")

MCP_TOOL_USAGE_POST = _usage_post_schema(tool_kind="mcp-tool", model_name="McpTool", example_id=7)
