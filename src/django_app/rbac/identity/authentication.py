...
from rbac.identity.api_keys.authenticator import ApiKeyAuthenticator
from rbac.models import ApiKey


class BearerAuthScheme(OpenApiAuthenticationExtension):
    target_class = "rbac.identity.authentication.JwtAuthentication"
    name = "BearerAuth"
...
class ApiKeyAuthScheme(OpenApiAuthenticationExtension):
    target_class = "rbac.identity.authentication.ApiKeyAuthentication"
    name = "ApiKeyAuth"
