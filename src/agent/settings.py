...
AGENT_DROP_UNSUPPORTED_LLM_PARAMS = env.str("AGENT_DROP_UNSUPPORTED_LLM_PARAMS")
...
KNOWLEDGE_PORT = env.str("KNOWLEDGE_PORT")

KNOWLEDGE_BASE_URL = f"http://{KNOWLEDGE_HOST}:{KNOWLEDGE_PORT}"
