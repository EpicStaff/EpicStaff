...
### Embedded assets license summary
...
### Embedded asset index

| Component | Where | License |
|---|---|---|
| Open Sans (font, weights 300/400/600/700, base64 TTF) | `styles.css` | OFL-1.1 |
| SheetJS Community Edition (`xlsx`) | `main.js` | Apache-2.0 |
| Angular v20.3.10 (`@angular/*`) | `main.js`, `polyfills.js` | MIT |
| RxJS | `main.js` | Apache-2.0 |
| tslib | `main.js` | 0BSD |
| ngx-markdown | `main.js` | MIT |
| marked | `main.js` | MIT |
| expr-eval | `main.js` | MIT |

### Open Sans (embedded font)
...
### SheetJS Community Edition (xlsx, embedded in main.js)
...
### Other libraries bundled in main.js

Identified from `// node_modules/<pkg>/` bundler comments and `@license` banners. Their verbatim license texts are the standard texts for the SPDX identifiers listed below; several of these packages also appear (at different versions) with full license texts in the frontend Notices section above.

- **Angular v20.3.10** (`@angular/core`, `common`, `forms`, `elements`, `cdk`, `platform-browser`) — MIT — https://github.com/angular/angular
